...
export async function POST(
  req: Request,
  // Perubahan tipe data: params kini dibungkus di dalam Promise sesuai standar Next.js 15
  { params }: { params: Promise<{ provider: string }> }
) {
  // Melakukan await untuk mengekstrak parameter 'provider' secara asinkronus
